      ...
      <ResponsiveContainer width="100%" height={200}>
        <BarChart data={data}>
          ...
          <YAxis tick={{ fontSize: 12 }}
            tickFormatter={v => (v as number).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL', maximumFractionDigits: 0 })} />
          <Tooltip
            formatter={(v: unknown) => [(v as number).toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' }), 'Total']} />
